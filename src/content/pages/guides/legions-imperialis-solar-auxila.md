---
title: "Solar Auxilia in Legions Imperialis"
summary: "Legions Imperialis Solar Auxilia unit review."
order: 13
hidden: false
---
...
**Modeling:**  You'll end up with more of these than you can use, feel free to get creative with the modeling. I use flag color to make it clear what's a Legate and what's a Tactical Command.
*5 models per base, 10 models per box, 2 bases per box*
...
**Modeling:**  You get 38 models in a box armed with lasrifles but you can mix in 3 other infantry models that don't belong to command squads, or extra command squads to get to 8 bases.
*5 models per base, 38 models per box, 8 bases per box*
...
**Modeling:**  I paint the tips of the flamers bronze (to my silver lasrifles) to make the units easy to tell apart at a distance. You don't get enough of these to make 4 bases of all flamers in a box, but throw in a sergeant or comms type character and you're good.
*5 models per base, 14 models per box, 4 bases per box*
...
**Modeling:**  No notes.
*5 models per base, 20 models per box, 4 bases per box*
...
**Modeling:**  No notes, these are very easy to paint due to the size compared to infantry.
*2 models per base, 8 models per box, 4 bases per box*
...
4 Auxiliaries, 2 Veletarii (42 pts) - This is a cheap unit to hold back points. The 2 Veletarii can be kept on charge orders so if anything threatens this objective you charge it to tie those units up for a turn.
...
**Modeling:**  I paint these off base on coffee stirrers like I do infantry, but do it however you'd like.
*4 models per box*
...
**Modeling:** You get options for all these tanks in one box. Traditional magnetization methods won't work as the guns sit in the middle of the tank, not a separate turret. But if you want to magnetize [this is a pretty clever guide to do so](https://www.reddit.com/r/LegionsImperialis/comments/18bnwii/comment/kdoitp1/).
...
You can take the Marauder Pathfinder as well, I don't love this because it's an 85 point plane to bugg 30 point tanks, but it will also let you hit on 4+ with indirect fire. Generally I think you should just take the Artillery Company if you're looking for this, but if you don't want to for whatever reason the Pathfinder is viable, as it's still a Marauder covered in guns a missiles.
...
**Modeling:** No real notes here, they're a little fiddly to assemble and note their infantry loader comes on the sprue.
*1 gun and 1 loader per base, 4 of each gun per box, (12 total)*
...
**Gameplay:** A common complaint among Auxilia players is that we lack access to a Rhino equivalent. And that's true, a Rhino-style unit in the list would be fantastic. We do however have the Arvus and it is a 12 point transport. Now, why doesn't this solve our Rhino needs? First, it's very vulnerable. To land troops you need to be in hover mode and you're now relying on your 6+ jink save. However when in hover mode you can take cover behind terrain so take advantage of that. The Arvus in hover mode can also now charge targets, block movement, and otherwise be annoying like Rhinos. You're lacking a point defense weapon but you have access to the other tricks. You do have quite large bases which is a blessing and a curse, you can block enemy movement incredible effectively, but getting multiple Arvuses into close combat when charging is tricky.

A minimum sized unit in a Lighter can get pretty much anywhere on the battlefield and only costs 54 points. Yes, it's vulnerable to overwatch, but if your opponent is overwatching this 56 point unit hopefully you can punish them with something else. The fact that the flyer can march 50" means that anything on the board is open to them.
