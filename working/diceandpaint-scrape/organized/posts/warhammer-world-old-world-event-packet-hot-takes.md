---
title: "Warhammer World Old World Event Packet Hot Takes"
source_url: "https://www.diceandpaint.net/blog/warhammer-world-old-world-event-packet-hot-takes"
kind: "blog-post"
date: "2024-11-01T13:41:51-0400"
summary: "For months rumors have circulated that GW will be publishing an Organized Play packet for Warhammer the Old World. We don't have that today but we do have an event packet for an upcoming event at Warhammer World which may provide us with some clues as to what to expect. This isn't the first Warham"
images:
  - images/blog/warhammer-world-old-world-event-packet-hot-takes/9ef49ee2b617.webp
preview_image: "posts/images/blog/warhammer-world-old-world-event-packet-hot-takes/preview.webp"
---
...
For months rumors have circulated that GW will be publishing an Organized Play packet for Warhammer the Old World. We don't have that today but we do have an [event packet for an upcoming event at Warhammer World](https://drive.google.com/file/d/1Js4P4Xjw4kmz5opwZuwbrkp7swPNO8_W/view?usp=sharing) which may provide us with some clues as to what to expect. This isn't the first Warhammer World Old World event but it's them moving to 2,000 points and adopting comp more restrictive than most community run events.

I do want to stress that this is just a GW tournament and we have no way of knowing what if any of these will receive any kind of official endorsement for organized play. As I've been [reviewing the metagame for SBOT2](https://www.diceandpaint.net/blog/sbot-2-list-review-part-1) I'll be using the 130 lists from that event as an easy source of data to look at the impact of this event packet.
