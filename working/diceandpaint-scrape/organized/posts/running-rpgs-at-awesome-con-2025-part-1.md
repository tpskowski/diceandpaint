---
title: "Running RPGs at Awesome Con(Part 1)"
source_url: "https://www.diceandpaint.net/blog/running-rpgs-at-awesome-con-2025-part-1"
kind: "blog-post"
date: "2025-04-13T15:53:00-0400"
summary: "Part 1 of reviewing my experience running RPGs at Awesome Con in Washington, DC. Covering a Star Wars: Age of Rebellion game and one of Eat the Reich."
images:
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/493acdac95a1.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/1146db7297f0.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/77bade93bd3a.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/7bed2a80924c.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/0dfb29854fdf.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/451aa4aff76d.webp
  - images/blog/running-rpgs-at-awesome-con-2025-part-1/b54dc9cfa062.webp
preview_image: "posts/images/blog/running-rpgs-at-awesome-con-2025-part-1/preview.webp"
---

# Running RPGs at Awesome Con(Part 1)

[rpg](/blog/category/rpg)[star wars](/blog/category/star+wars)
...
The other weekend I volunteered to GM at [Awesome Con](https://awesome-con.com/), a comic convention in DC. Over the past several years a local gaming store, [Labyrinth Games and Puzzles](https://www.labyrinthdc.com/) has run tabletop gaming events there and it's impressive to see the fast growth. I don't know the full count but there were dozens of RPG sessions run on top of the board gaming, card games, and some Blood on the Clocktower. It's nice to ese that pretty quickly this event has seen the tabletop gaming presence grow.

I signed up to run three sessions: [Star Wars: Age of Rebellion](https://www.edge-studio.net/categories-games/star-wars-aor/); [Eat the Reich](https://rowanrookanddecard.com/product/eat-the-reich/?v=0b3b97fa6688); and [Dungeon Crawl Classics](https://goodman-games.com/dungeon-crawl-classics-rpg/). I was a little nervous submitting these because there are always more players who are only interested in D&D than DMs only interested in D&D. Labyrinth did a good job with prep, I was given time slots two months out and a week before the event they had a Zoom covering various procedures for the event.
...
This module was released for free in 2014 and has a good reputation online so I decided to give it a (one) shot. The first issue I'll say is that while the module is available for free [online](https://www.starwars-universe.com/images/multimedia/Images/Litterature/jeux-de-role/rescue_glare_peak/rescue_glare_peak.pdf), it has been uploaded as a scan. And not a good one. And that's pretty annoying, but not game-breaking. I considered printing it out but being a poor quality scan it'd eat ink so I just went with it on my tablet. The character sheets I printed out were hard to read and one player struggled with that, which I feel bad about.
...
One of the first things I did for perp was to make an opening crawl. You can do this easily [online](https://starwarsintrocreator.kassellabs.io/#!/FONVFuE-8WXg4xtgl_GX), though there are a few frustrations. First, there is a big watermark, I attempted to edit the HTML to delete that but it didn't work, deleting the watermark broke the crawl itself. Secondly they offer to let you download it, but they want you to pay or wait months. So I ended up doing a screen recording, watermark and all to make sure I could play it at the con. I played it on my tablet and that went fine and I think really does set the mood. The module includes a crawl but I found it overly short and not well written so I revised it.
...
I think with more experience and outside of a one-shot setting combat would be more interesting and would move faster, but I still don't think this is the combat system I'm looking for. One thing I want to call out is how it works with theater of the mind and rage bands. The game's attack rolls depend on how far away you are from enemies, but if you have 4 PCs and 5 enemies that means you might need to be tracking 20 separate rage bands. I think range bands work best when they're more abstracted than this, thought I'll shout out [Wilderfeast](https://horribleguild.com/eu/product-category/roleplaying-games/wilderfeast/) for having an amazing relative range band system, but that only really works because the fights are one-versus-many.
...
Another thing I realized is that next time I play this I'm bringing some little glass beads. Eat the Reich lets vampires share blood (their power and and healing pool) and this group really liked doing that, and having little tokens to hand around would have been more fun and tactile than tracking it on their character sheet. I have some on-theme [dice from Baron of Dice](https://baronofdice.com/collections/fantasy-wargaming-collection/products/bloody-bite-16mm-dice) that I think also really help set the mood, having the bite symbol on the 6 reminds players it's a crit. I use standard D6s as the GM because the GM doesn't crit.
...
Having now run the base scenario twice I want to try something else in the system. I have a Call of Cthulhu [supplement set in 1920s Japan](https://www.drivethrurpg.com/en/product/446091/japan-empire-of-shadows-a-call-of-cthulhu-sourcebook-for-1920s-imperial-japan) and I may take some parts of that to make a Hiro**eato** game as the book suggests. I may also check out [ReVamped](https://geckopirate.itch.io/revamped) again, which I highly recommend picking up if you like the base game.

### Coming next… [Part 2 with Dungeon Crawl Classics](/blog/rpgs-at-awesome-con-part-2-dcc-amp-con-thoughts)

[rpg](/blog/tag/rpg)[starwars](/blog/tag/starwars)[eatthereich](/blog/tag/eatthereich)[convention](/blog/tag/convention)
